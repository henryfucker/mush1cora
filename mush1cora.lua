...
local function ShowNotification(title, text, icon)
    ...
    notification.BackgroundColor3 = CONFIG.COR_SECUNDARIA
    ...
    titleLabel.Font = CONFIG.FONTE
    titleLabel.TextSize = 18
    titleLabel.TextColor3 = CONFIG.COR_PRINCIPAL
    ...
    if icon then
        ...
        iconImage.Position = UDim2.new(1, -40, 0, 5)
...
local function CriarJanelaAviso()
    ...
    Divider.BackgroundColor3 = CONFIG.COR_PRINCIPAL
    ...
    WarningText.Size = UDim2.new(0.9, 0, 0, 220)
    ...
    Sound.SoundId = "rbxassetid://138080526" -- Windows 95 Startup
    Sound.Volume = 1
    ...
    TweenService:Create(MainFrame, TweenInfo.new(0.5), {Size = UDim2.new(0, 450, 0, 350)}):Play()
end
...
function CriarMainGUI()
    ...
    -- Animação de entrada
    MainFrame.Size = UDim2.new(0, 0, 0, 0)
    local tween = TweenService:Create(MainFrame, TweenInfo.new(0.5), {Size = UDim2.new(0, 600, 0, 400)})
    tween:Play()
end
